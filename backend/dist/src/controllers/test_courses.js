...
const test_curses_1 = require("../db/crud/test_curses");
const ListCourses = (_, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const courses = yield (0, test_curses_1.ListCurses)();
        res.status(200).json({
            estatus: 200,
            courses
        });
...
const CreateCourses = (Req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const courses = yield (0, test_curses_1.CreateCurses)({ c_id: null, name, credits });
        res.status(200).json({
            estatus: 200,
            courses
        });
...
const UpdateCourses = (Req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield (0, test_curses_1.UpdateCurses)({ c_id: id, name, credits });
        res.status(200).json({
            estatus: 200,
...
const DeleteCourses = (Req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = Req.body;
        const courses = yield (0, test_curses_1.DeleteCurses)(id);
        if (courses === 0) {
            res.status(400).json({
                estatus: 400,
