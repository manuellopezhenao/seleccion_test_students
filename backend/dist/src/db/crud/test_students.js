...
exports.DeleteStudent = exports.UpdateStudents = exports.CreateStudents = exports.ListStudents = void 0;
const test_students_1 = require("../models/test_students");
const ListStudents = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const students = yield test_students_1.TestStudents.findAll();
        return students;
    }
    catch (err) {
...
const CreateStudents = (students) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const student = yield test_students_1.TestStudents.create({
...
const UpdateStudents = (students) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const student = yield test_students_1.TestStudents.update({
            first_name: students.first_name,
            last_name: students.last_name,
            lv_id: students.lv_id,
            group: students.group,
...
const DeleteStudent = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const students = yield test_students_1.TestStudents.destroy({
            where: {
                s_id: id
            }
        });
...
//# sourceMappingURL=test_students.js.map